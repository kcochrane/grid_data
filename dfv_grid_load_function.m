...
function[dfV,IV,df_topo,I_topo,V,x,y,x_topo,y_topo]=dfv_grid_load_function(grid_folder,I_topo_file,df_topo_file,dfV_file,IV_file,up_dn,fwd_bkwd,nV_smooth,nxy_smooth,C);
...
% grid_folder='flat20160511';
% dfV_file='20160511-104027_Ag(111)_NaCl_PTCDA--479_1.Df(V)_flat';
% IV_file='20160511-104027_Ag(111)_NaCl_PTCDA--479_1.I(V)_flat';
% I_topo_file='20160511-104027_Ag(111)_NaCl_PTCDA--190_1.I_flat';
% df_topo_file='20160511-104027_Ag(111)_NaCl_PTCDA--190_1.Df_flat';
% up_dn=1; 
% fwd_bkwd=0;
